...
class TestEmbeddingManager(unittest.TestCase):
    ...
    def test_embed_document(self):
        ...
        self.client.make_request.assert_called_with(
            "POST", 
            "/embed/document", 
        ...
        self.client.make_request.assert_called_with(
            "POST", 
            "/embed/document", 
            params={"doc_id": "doc123", "model": "text-embedding-ada-002"}
        )
    ...
    def test_list_embeddings(self):
        ...
        expected_response = {
            "embeddings": [
                {"document_id": "doc123", "model": "text-embedding-ada-002"},
                {"document_id": "doc456", "model": "text-embedding-ada-002"}
            ],
            "total": 2
        }
        self.client.make_request.return_value = expected_response
    ...
    def test_embed_documents(self):
        ...
        self.client.make_request.assert_called_with(
            "POST", 
            "/embed/documents", 
            json={"document_ids": document_ids, "model": "text-embedding-ada-002"}
        )
    ...
    def test_delete_embedding(self):
        """Test deleting an embedding for a document."""
        # Setup mock response
