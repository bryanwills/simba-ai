...
class RetrieverFactory:
    ...
    @staticmethod
    def get_retriever(method: Union[str, RetrievalMethod], vector_store=None, **kwargs) -> BaseRetriever:
        """
    ...
    def from_config(config: Dict[str, Any] = None) -> BaseRetriever:
        ...
        method = config.pop('method', RetrievalMethod.DEFAULT) if isinstance(config, dict) else RetrievalMethod.DEFAULT
