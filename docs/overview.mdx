...
<CardGroup cols={2}>
  <Card title="Cloud" icon="cloud" iconType="solid" href="/getting-started/cloud">
    Get started using Simba through our Cloud offering, free of charge.
    Perfect for fast serverless deployment.
  </Card>

  <Card title="Self Hosted" icon="server" iconType="solid" href="/getting-started/self-hosted">
